	        	...
	        	<div class="col-md-3 col-sm-8 footer-social d-flex">
        			<div class="d-inline-block align-self-center">
	        			<p class="bg-light">
                            ...
                            <?=  $this->Html->image('NIC.png', ["title"=>"NIC logo",'alt' => 'NIC logo']); ?>

                        </p>
	        			<p class="bg-light mb-0">
                            <!-- <img src="images/digital-india.png" alt="digital india logo"> -->
                            <?=  $this->Html->image('digital-india.png', ["title"=>"digital india logo",'alt' => 'digital india logo']); ?>
...
<?= $this->Html->script(['popper.min','../vendor/jquery/jquery.min','../vendor/bootstrap/js/bootstrap.min.js','jquery.slicknav.min.js']); ?>
  <!-- Menu Toggle Script -->
  <script>
