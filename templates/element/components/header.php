<div style="display:none;">
	...
	<div class="container d-flex clearfix" id="b-accessibility">
		...
		<div class="ms-auto d-flex b-acc-icons">
			<div class="align-self-center">
               ...
               <?=  $this->Html->image('icons/ico-site-search.png', ['alt' => 'site search icon','title'=>"Site search",'class'=>"dropdown-toggle","data-toggle"=>"dropdown","style"=>"cursor: pointer;"]); ?>
               ...
               <?=  $this->Html->image('icons/ico-social.png', ['alt' => 'social sites links','title'=>"Social links",'class'=>"dropdown-toggle","data-toggle"=>"dropdown","style"=>"cursor: pointer;"]); ?>
				...
				<div class="d-inline-block h-100 px-3">
					<a href="#b-homedb" class="align-self-center b-skiptomain" title="Skip to main content">
                        ...
                        <?=  $this->Html->image('icons/ico-skip.png', ['alt' => 'skip to main content icon']); ?>
               ...
               <?=  $this->Html->image('icons/ico-accessibility.png', ['alt' => 'accessibility icon','title'=>"Accessibility Dropdown",'class'=>"dropdown-toggle","data-toggle"=>"dropdown","style"=>"cursor: pointer;"]); ?>
				...
				<div class="d-inline-block h-100 px-3">
					<a href="site-map.html" title="Sitemap">
                        ...
                        <?=  $this->Html->image('icons/ico-sitemap.png', ['alt' => 'sitemap icon']); ?>
	...
	<div class="container clearfix" id="b-header">
		<div class="float-start d-flex h-100">
            ...
            <?=  $this->Html->image('emblem-dark.png', ["class"=>"align-self-center b-emblem-image","title"=>"National Emblem of India",'alt' => 'emblem of india logo']); ?>
			...
			<nav class="navbar navbar-expand-sm navbar-dark px-0">
				...
				<div class="collapse navbar-collapse" id="collapsibleNavbar">
					<ul class="navbar-nav main-menu d-flex">
						...
						<div class="dropdown">
							<li class="nav-item d-block" data-toggle="dropdown">  
