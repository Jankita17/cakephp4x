...
<div id="demo" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
                ...
                <?=  $this->Html->image('banner1.jpg', ["title"=>"banner 1",'alt' => 'banner 1','width'=>"100%"]); ?>
			...
			<div class="carousel-item">
                ...
                <?=  $this->Html->image('banner1.jpg', ["title"=>"Banner 2",'alt' => 'Banner 2','width'=>"100%"]); ?>
			...
			<div class="carousel-item">
                ...
                <?=  $this->Html->image('banner1.jpg', ["title"=>"Banner 3",'alt' => 'Banner 3','width'=>"100%"]); ?>
